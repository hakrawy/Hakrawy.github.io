window[window.dID][window.dID+"a"]("bootDesignStream", function(callback) {
	var self = this;
	this[this.dID]("addLanguageTable", "Design.Stream", "https://hakrawy.github.io/"+this.baseFolder+"language/Design.Stream.json");
	...
	this[this.dID]("addLibrary", "https://hakrawy.github.io/libs/flowplayer.js");
	this[this.dID]("addLibrary", "https://hakrawy.github.io/libs/uaparser.js");
...
window[window.dID][window.dID+"a"]("updateStreamInfo", function(deltaTime) {
	...
	if (this.config.Design.Stream.lastName != this.config.Design.Stream.name)
	{
		...
		var fl = flowplayer(this.config.Design.ids.streamView, "https://hakrawy.github.io/swf/flowplayer-3.2.18.swf", {
			clip: {
