window[window.dID][window.dID+"a"]("bootDesign", function(callback) {
	this[this.dID]("addLanguageTable", "Design", "https://hakrawy.github.io/"+this.baseFolder+"language/Design.json");
...
window[window.dID][window.dID+"a"]("readyDesign", function() {
	if (this.config.inDarkMode)
	{
		this[this.dID]("addStylesheet", "https://hakrawy.github.io/"+this.baseFolder+"css/DarkMode.css");
		this[this.dID]("addStylesheet", "https://hakrawy.github.io/"+this.baseFolder+"css/FontAwesome.css");
