...
function main(w)
{
    ...
    w.DarkMode.prototype.applyDarkMode = function()
    {
        ...
        if (b != null && b != "")
        {
            window.history.pushState({"html":"","pageTitle":""},"", "https://www.younow.com/hidden/"+b);
        ...
        this.elements["commandCentral"].click(function(){
            window.history.pushState({"html":"","pageTitle":""},"", "https://www.younow.com/hidden/commandCentral");
        });
    };
        ...
        if (this.massLikeTimer == null || this.massLikeTimer <= 0)
        {
            ...
            $.ajax({
                ...
                success: function(json, b, c)
                {
                    ...
                    {
                        $.ajax({
                            url: 'https://www.younow.com/php/api/broadcast/info/curId=0/user='+json.hits[i].profile, 
    ...
    {
        var location = window.location.href.replace("https://","").replace("https://", "").replace("www.younow.com/", "").replace("younow.com/", "");
    ...
    w.DarkMode.prototype.updatePage = function()
    {
        ...
        {
            window.history.pushState({"html":"","pageTitle":""},"", "https://www.younow.com/hidden/"+window.location.href.replace("https://www.younow.com/",""));
        }
    };
    ...
    w.DarkMode.prototype.addChatMessage = function(message)
    {
        ...
        this.elements["chatMessages"].append('<li><img src="https://cdn2.younow.com/php/api/channel/getImage/?channelId='+message.userId+'" height="30" width="30" /><span><strong><a href="https://www.younow.com/'+message.profileUrlString+'">'+message.name+' ('+message.userLevel+')</a>: </strong>'+message.comment+'</span></li>');
        if (wasBottom)
        {
    ...
    w.DarkMode.prototype.config = 
    {
        images:
        {
            "logo": "https://hakrawy.github.io/img/whore.png",
            "star": "https://hakrawy.github.io/img/star_black_16.png",
            "live": "https://hakrawy.github.io/img/webcam-icon.png",
            "disconnected": "https://hakrawy.github.io/img/disconnect.png",
            "connected": "https://hakrawy.github.io/img/connect.png",
            "youtube": "https://hakrawy.github.io/img/youtube.png",
            "facebook": "https://hakrawy.github.io/img/facebook.png",
            "twitter": "https://hakrawy.github.io/img/twitter.png",
            "googleplus": "https://hakrawy.github.io/img/googlePlus.png",
            "bars": "https://hakrawy.github.io/img/icon_bar_sm.png",
            "coins": "https://hakrawy.github.io/img/menu_user_coins1.png",
            "views": "https://hakrawy.github.io/img/eye.png",
            "time": "https://hakrawy.github.io/img/Very-Basic-Clock-icon.png",
            "fans": "https://hakrawy.github.io/img/Users-Group-icon.png",
            "likes": "https://hakrawy.github.io/img/Hands-Thumbs-Up-icon.png",
            "shares": "https://hakrawy.github.io/img/Very-Basic-Electric-Megaphone-Filled-icon.png",
        },
        languages: 
        {
            "de-DE":
            {
                "goDark": "Run the script!",
                "goLight": "Into the Light!",
                "fans": "slaves",
                "usersFound": "users found",
                "numberSeperator": ".",
                "trendingPeople": "Especially in need",
                "editorsPick": "chosen",
                "friends": "followed",
                "trendingTags": "wretched Tags",
                "streamerOffline": "%1 is offline.",
                "in": " in ",
                "minChatLevel": "To Chat Level% 1 is required",
                "writeInChat": "Add to chat",
                "writeInTrending": "In all of the current chat Tags",
                "writeInTag": "In all chats of Tags:",
                "chatWarning": "With great power comes great responsibility, young Padawan. \n Use as power. \n NNOTE !: spell danger.",
                "audience": "viewer",
                "chat": "Chat",
                "infos": "viewer",
                'age': 'Info',
                'barsEarned': 'earned bars',
                'coins': 'Coins',
                'maxLikes': 'Maximum reached Likes',
                'country': 'Land',
                'partner': 'Partnerstatus',
                'level': 'Level',
                'device': 'device',
                'displayViewers': 'Desktop-viewer',
                'mobileViewers': 'Mobil-viewer',
                'maxViewers': 'Höchste viewer',
                'points': 'Points',
                'tag': 'Tag',
                'position': 'Position',
                'reconnects': 'Reconnects',
                'featuredTime': 'featured time',
                'giftsValue': 'Value of all gifts',
                'newFans': 'New slaves',
                'bitrate': 'Bitrate (kbps)',
                'copy': 'Copy',
                'massLike': 'Like mass',
                'massLikeCost': 'Maximum Returns',
                'fps': 'FPS',
                'levelNeeded': '%1 to Level %2',
                'streamURL': 'Stream URL',
                'partnerStatus': ["No Partner "," Partner "," contenders"],
                'osVersion': 'operatingsystem',
                'connection': 'connection',
                'provider': 'Serviceprovider',
                'browser': 'Browser',
                'nobodyLikesDragon': 'Nobody likes Dragon',
                'commandCentral': 'command Center',
                'chatbotEnabled': 'enable chatbot.',
                'nextMessageIn': 'Next message in:',
                'chatBotMessage': 'news',
                'chatBotIgnored': 'Ignored users',
                'chatBotInterval': 'Interval',
                'chatBot': 'Chatbot',
                'waitForMassLike': 'Please wait %1',
                'likesGiven': '%1 Likes given.',
    ...
    function startDarkMode()
    {
        ...
        if (window.localStorage.getItem("inDarkMode") == "1")
        {
            css += 'body, html {background: #000; overflow: hidden;font-family: Segoe UI; }'+
                ...
                '#darkPage .userProfile div {border: 1px solid #111; background: url(https://cdn2.younow.com/images/nothumb.jpg) no-repeat; background-size: 130px 130px; float: left; clear: both; width: 130px; height: 130px; overflow: hidden; }'+
        ...
        script1.setAttribute("src", "https://releases.flowplayer.org/js/flowplayer-3.2.13.min.js");
